...
function Home({ children }) {
  ...
  const checkDisThaiCharacters = (input) => {
    const thaiPattern = /[ก-๙]/;
    return thaiPattern.test(input);
  };

  const handlePasswordChange = (e, name) => {
    const input = e.target.value;

    if (!checkDisThaiCharacters(input)) {
      if (name === "password") {
        setPassword(input);
      }
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <Grid container justifyContent="flex-end" item xs={6} sx={{ pr: 1 }}>
            <IconButton
              onClick={() => {
                Swal.fire({
            ...
            <Grid container justifyContent="space-between">
              {credit !== undefined ? (
                ...
                >
                  ...
                  <CachedIcon fontSize="10px" onClick={() => getCredit()} />
                </Typography>
              ) : (
                <Skeleton
                  variant="text"
              ...
              >
                <PersonOutlineIcon sx={{ color: "#00897b", mr: "3px" }} />
                <Typography
                  sx={{ color: "#000", fontWeight: 100, fontSize: "12px" }}
                >
                  ข้อมูลส่วนตัว
                </Typography>
              </Button>
          ...
          >
            <Grid container>
              ...
              <Grid item sx={{ ml: 1, mt: 1 }}>
                <Typography sx={{ color: "#fff" }}>Diamond</Typography>
              ...
              <Grid item sx={{ ml: 1, mt: 1 }}>
                ...
                <Typography
                  sx={{ mt: 1, ml: 1, fontSize: "10px", color: "white" }}
                >
                  0 pts จะหมดอายุ
                </Typography>
              </Grid>
        ...
        >
          ...
          {page === "home" ? (
            ...
            <WithdrawComponent setCredit={setCredit} />
          ) : page === "history" ? (
                ...
                >
                  <Grid container>
                    ...
                    <Grid item sx={{ ml: 1, mt: 1 }}>
                      <Typography sx={{ color: "#fff" }}>Diamond</Typography>
                      <Typography
                        sx={{ color: "#fff", fontSize: "10px", mt: 1 }}
                      >
                        เติม 1000฿ จะได้ Commander
                      </Typography>
                    </Grid>
                    ...
                    <Grid item sx={{ ml: 1, mt: 1 }}>
                      <Grid container>
                        <AppsIcon sx={{ color: "white" }} />
                        <Typography
                          sx={{ mx: 1, color: "white", fontSize: "14px" }}
                        >
                          0 pts
                        </Typography>
                      </Grid>
      ...
      >
        <DialogTitle>
          <Typography sx={{ color: "#41A3E3", fontSize: "18px" }}>
            {" "}
            ข้อมูลส่วนตัว
          </Typography>
        </DialogTitle>
      ...
      >
        ...
        <DialogContent>
          <img
            src="https://public-cdn-softkingdom.sgp1.cdn.digitaloceanspaces.com/1687252504969-Rank-General.png"
            width={"100%"}
            height={130}
            style={{ borderRadius: "10px" }}
          />
          <img
            src="https://public-cdn-softkingdom.sgp1.cdn.digitaloceanspaces.com/1687252504979-Rank-Silver.png"
            width={"100%"}
            height={130}
            style={{ borderRadius: "10px" }}
          />
          <img
            src="https://public-cdn-softkingdom.sgp1.cdn.digitaloceanspaces.com/1687252504967-Rank-Gold.png"
            width={"100%"}
            height={130}
            style={{ borderRadius: "10px" }}
          />
      ...
      >
          ...
          {forgotPassword === 0 ? (
            ...
            <>
              ...
              <Grid container direction="column">
                <Typography sx={{ mt: 2, color: "#4B4949", fontSize: "16px" }}>
                  ยืนยันตัวตน OTP
                </Typography>

                <Typography sx={{ mt: 1, color: "#707070", fontSize: "14px" }}>
                  ส่งรหัส 6 หลักไปที่ {profile.tel}
                </Typography>
                ...
                <Typography sx={{ color: "#707070", fontSize: "14px" }}>
                  รหัสอ้างอิง : {dataOTP?.refno}
                </Typography>
              </Grid>
              <Grid container direction="row">
                <Typography sx={{ color: "#707070", fontSize: "12px", mt: 1 }}>
                  ไม่ได้รับรหัส OTP ?{" "}
                </Typography>
                {!sendOTPAgain ? (
                  <Typography
                    sx={{ color: "#707070", fontSize: "12px", mt: 1, ml: 1 }}
                  >
                    ส่งรหัสอีกครั้งในอีก 30 วินาที
                  </Typography>
                ) : (
                  <Button variant="text" onClick={() => sendPasswordOTP()}>
                    <Typography
                      sx={{
                        color: "#41A3E3",
                        fontSize: "12px",
        ...
        <DialogActions>
          <Button
            variant="outlined"
            onClick={() => setOpenDialogChangePassword(false)}
          >
            ปิด
          </Button>
        </DialogActions>
