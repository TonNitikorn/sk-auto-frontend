...
function Register() {
  ...
  const confirmOTP = async () => {
    try {
      ...
      console.log(error);
      if (
        error.response.data.error.status_code === 500 &&
  ...
  const registerUser = async () => {
    ...
    const response = await dispatch(
      register({
        ...
        token: dataOTP.token,
        pin:
          tabOtp[0] + tabOtp[1] + tabOtp[2] + tabOtp[3] + tabOtp[4] + tabOtp[5],
        password: password,
      })
    );
            ...
            <Box sx={{ mt: 10 }}>
              ...
              >
                ...
                >
                  ...
                  <Typography sx={{ color: "#41A3E3", ml: 1 }}>
                    สมัครสมาชิก
                  </Typography>
                </Grid>
                ...
                <Grid container direction="row" sx={{ mt: 1 }}>
                  <Typography
                    sx={{ color: "#707070", fontSize: "12px", mt: 1 }}
                  >
                    มีบัญชีอยู่แล้ว ?{" "}
                  </Typography>
                  <Button
                ...
                <Grid
                  ...
                  sx={{ mt: 3 }}
                >
                  <Typography sx={{ color: "#979797", fontSize: "14px" }}>
                    1/3
                  </Typography>
                </Grid>
              </Paper>
              ...
              >
                ...
                >
                  ...
                  />
                  <Typography
                    sx={{ color: "#7C7C7C", fontSize: "10px", ml: 1 }}
                  >
                    ย้อนกลับ
                  </Typography>
                </Button>
                ...
                >
                  <Typography sx={{ color: "#fff", fontSize: "10px", mr: 1 }}>
                    {" "}
                    ต่อไป {"  "}
                  </Typography>
            ...
            <Box sx={{ mt: 10 }}>
              ...
              >
                ...
                <Grid container direction="column" sx={{ mt: 3 }}>
                  ...
                  <Typography
                    sx={{ mt: 1, color: "#707070", fontSize: "14px" }}
                  >
                    ส่งรหัส 6 หลักไปที่ {rowData.tel || ""}
                  </Typography>
              ...
              <form onSubmit={handleSubmit}>
                <Box sx={{ mt: 10 }}>
                  ...
                  >
                    ...
                    <Grid container direction="column" sx={{ mt: 3 }}>
                      ...
                      >
                        ...
                        <MenuItem value="IBANK">
                          ธนาคารอิสลามแห่งประเทศไทย
                        </MenuItem>
                      </TextField>

                      <Typography
                        sx={{ mt: 1, color: "#707070", fontSize: "12px" }}
                      >
                        หมายเลขบัญชี*
                      </Typography>
                      <TextField
                      ...
                      <TextField
                        ...
                        error={checkDisThaiCharacters(password)}
                        helperText={
                          checkDisThaiCharacters(password)
                            ? "ห้ามใช้ภาษาไทยในรหัสผ่าน"
                            : ""
                        }
                        sx={{ bgcolor: "white", borderRadius: 1 }}
                        InputProps={{
                  ...
                  >
                    ...
                    >
                      <Typography
                        sx={{ color: "#fff", fontSize: "10px", mr: 1 }}
                      >
                        {" "}
                        ต่อไป {"  "}
                      </Typography>
            ...
            >
              ...
              >
                <KeyboardBackspaceIcon
                  ...
                  sx={{ color: "#7C7C7C" }}
                />
                <Typography sx={{ color: "#7C7C7C", fontSize: "10px", ml: 1 }}>
                  ย้อนกลับ
                </Typography>
              </Button>
              <Button
